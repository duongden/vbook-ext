function execute(url, page) {
    ...
    let response = fetch("https://www.wcxs5.com" + url + "1-" + page + ".html");
    console.log("https://www.wcxs5.com" + url + "1-" + page + ".html")
    if (response.ok) {
		...
		doc.select(".container .item").forEach(e => {
            data.push({
                ...
                link: "https://www.wcxs5.com" + e.select("h3 a").first().attr("href"),
