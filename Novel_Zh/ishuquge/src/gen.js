function execute(url, page) {
    if (!page) page = '1';
    const doc = Http.get("http://www.ishuquge.org/category/"+url+"_"+page+".html").html();
    ...
    for (var i = 0; i < el.size(); i++) {
        ...
        data.push({
            ...
            cover: 'http://www.ishuquge.org/files/article/image/'+fol+'/'+booKId+'/'+booKId+'s.jpg',
            description: e.select(".s4").text(),
            host: "http://www.ishuquge.org"
        })
    }
