function execute(url, page) {
    if (!page) page = '1';
    const doc = Http.get("https://www.shouda8.net/"+url+"_"+page+"/").html();
    ...
    for (var i = 0; i < el.size(); i++) {
        ...
        data.push({
            ...
            cover: 'https://www.shouda8.net/files/article/image/'+fol+'/'+booKId+'/'+booKId+'s.jpg',
            description: e.select(".s4").text(),
            host: "https://www.shouda8.net"
        })
    }
